...
type testService struct {
  ...
  client service.ProductsApiServiceClient
  cleanup   func()
}
...
func setupTestService(t *testing.T) *testService {
  ...
  service.RegisterProductsApiServiceServer(grpcServer, &ProductsApiService{
    nextID: 1,
  })
  ...
  client := service.NewProductsApiServiceClient(conn)
